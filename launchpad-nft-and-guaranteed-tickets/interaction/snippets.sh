...
ADDRESS="moa1qqqqqqqqqqqqqpgqptlxkvh3djyq2x3adf00pgtlrdl4czmrad7qk8l04q"
...
deploy() {
    ...
    moapy --verbose contract deploy --bytecode="../output/launchpad-nft-and-guaranteed-tickets.wasm" --recall-nonce --pem=${OWNER_PEM_PATH} \
    --gas-limit=200000000 \
...
#   $1 = Address
setTransferRole() {
    local ADDRESS_HEX="0x$(moapy wallet bech32 --decode $1)"
