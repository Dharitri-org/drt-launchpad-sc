    ...
    crate::launch_stage::LaunchStageModule + crate::config::ConfigModule
{
    ...
    fn set_ticket_price(&self, token_id: MoaxOrDctTokenIdentifier, amount: BigUint) {
    ...
    fn try_set_ticket_price(&self, token_id: MoaxOrDctTokenIdentifier, amount: BigUint) {
