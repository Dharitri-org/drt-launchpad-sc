...
pub trait TokenSendModule: crate::config::ConfigModule {
    ...
    fn send_launchpad_tokens<
        SendLaunchpadTokensFn: Fn(&Self, &ManagedAddress, &DctTokenPayment<Self::Api>),
    >(
        &self,
        ...
        let payment = DctTokenPayment::new(launchpad_token_id, 0, launchpad_tokens_amount_to_send);
