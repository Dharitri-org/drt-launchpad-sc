...
ADDRESS="moa1qqqqqqqqqqqqqpgqww6yy7u5fddnejxf0m5z7qtluu06c8g6ad7q86tzup"
...
NFT_COST="0x00000000044d4f4158000000000000000000000007470DE4DF820000" # 0.02 MOAX
...
deploy() {
    ...
    moapy --verbose contract deploy --bytecode="../output/launchpad-with-nft.wasm" --recall-nonce --pem=${OWNER_PEM_PATH} \
    --gas-limit=200000000 \
