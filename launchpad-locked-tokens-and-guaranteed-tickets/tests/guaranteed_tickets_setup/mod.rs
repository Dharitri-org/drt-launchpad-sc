...
use dharitri_sc::types::{
    Address, MoaxOrDctTokenIdentifier, DctLocalRole, MultiValueEncoded, OperationCompletionStatus,
};
        ...
        + Fn() -> launchpad_locked_tokens_and_guaranteed_tickets::ContractObj<DebugApi>,
{
    pub fn new(lp_builder: LaunchpadBuilder) -> Self {
        ...
        b_mock.set_dct_balance(&owner_address, LAUNCHPAD_TOKEN_ID, &total_launchpad_tokens);
