...
ADDRESS=$(moapy data load --key=address-sc)
...
TICKET_PRICE=100000000000000000 # 0.1 MOAX
...
deploy() {
    ...
    moapy --verbose contract deploy --bytecode="../output/launchpad.wasm" --recall-nonce --pem=${OWNER_PEM_PATH} \
    --gas-limit=200000000 \
